  ...
  const handleReschedule = async (id: string) => {
    ...
    try {
      ...
      setBookings(
        bookings.map((b) =>
          b.id === id
            ? { ...b, bookingDate: res.data.data.booking.bookingDate }
            : b,
        ),
      );
  ...
  const submitReview = async (bookingId: string) => {
    ...
    try {
      ...
      setBookings(
        bookings.map((b) =>
          b.id === bookingId
            ? { ...b, review: { rating: data.rating, comment: data.comment } }
            : b,
        ),
      );
    } catch (error: unknown) {
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] text-gray-100 pt-32 pb-12 px-4 selection:bg-white/20">
      <div className="container mx-auto max-w-6xl grid grid-cols-1 lg:grid-cols-4 gap-8 mb-12">
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="flex flex-col gap-6">
            <div>
              <h1 className="text-4xl font-bold tracking-tight mb-2 bg-gradient-to-r from-white to-gray-500 bg-clip-text text-transparent font-heading">
                My Dashboard
              </h1>
            ...
            <Card className="border-yellow-500/30 bg-gradient-to-br from-[#141414] to-yellow-900/10 rounded-3xl relative overflow-hidden transition-all duration-300 hover:shadow-[0_0_30px_rgba(234,179,8,0.15)] hover:scale-[1.02]">
              ...
              <CardContent className="pt-4 relative z-10">
                ...
                <p className="text-sm text-gray-400 font-light mb-4">
                  View your tier, unlock perks, and earn more points.
                </p>
        ...
        <div className="lg:col-span-3 space-y-4">
          <Tabs defaultValue="bookings" className="w-full">
            <TabsList className="mb-6 bg-[#141414] border border-white/10 p-1 rounded-xl w-full sm:w-auto h-auto">
              <TabsTrigger
                value="bookings"
                className="data-[state=active]:bg-white/10 data-[state=active]:text-white text-gray-400 rounded-lg py-2.5 px-6 font-medium transition-all"
              >
                Recent Bookings
              </TabsTrigger>
              <TabsTrigger
            ...
            <TabsContent value="bookings" className="space-y-6">
              {bookings.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-24 text-center bg-[#141414] rounded-[2rem] border border-white/5 shadow-2xl relative overflow-hidden">
                  ...
                  <p className="text-2xl font-bold font-heading text-white relative z-10 mb-2">
                    No bookings yet
                  </p>
                  <p className="text-gray-400 font-light relative z-10 mb-8 max-w-xs">
                    You haven't booked any premium services yet. Treat your
                    vehicle today.
                  </p>
                  <Link href="/book" className="relative z-10">
                    <Button className="h-12 px-8 bg-white text-black hover:bg-gray-200 font-bold tracking-widest uppercase text-xs rounded-xl transition-all">
                      Book a Wash
                    </Button>
                  </Link>
                </div>
                ...
                bookings.map((booking, index) => {
                  ...
                  return (
                    <Card
                      key={booking.id}
                      className="overflow-hidden border-white/10 bg-[#141414] shadow-2xl rounded-3xl relative"
                    >
                      <div className="absolute inset-0 bg-gradient-to-b from-white/[0.02] to-transparent pointer-events-none" />
                      ...
                      >
                        <div className="flex items-center gap-4">
                          <h3 className="font-bold text-2xl font-heading text-white">
                          ...
                          <div className="flex flex-col lg:flex-row relative z-10 p-6 pt-0 lg:p-8 lg:pt-0 gap-8 items-center border-t border-white/5 mt-4">
                                  ...
                                  booking.status !== "CANCELLED" && (
                                    <div className="mt-8 mb-2 flex items-center justify-between w-full max-w-md mx-auto">
                                      {[
                                        ...
                                        const isPast = s.statuses.includes(
                                          booking.status,
                                        );
                                        return (
                                          <div
                                          ...
                                          >
                                            {idx > 0 && (
                                              <div
                                                className={`w-full h-[2px] absolute top-3.5 right-1/2 ${isPast ? "bg-blue-500" : "bg-white/10"}`}
                                              />
                                            )}
                                            <div
                                              className={`w-7 h-7 rounded-full z-10 flex items-center justify-center text-xs font-bold transition-all duration-300 ${isPast ? "bg-blue-500 text-white shadow-[0_0_15px_rgba(59,130,246,0.5)]" : "bg-[#141414] border-2 border-white/10 text-gray-500"}`}
                                            >
                                              {isPast ? "✓" : s.step}
                                            </div>
                                            <span
                                              className={`text-[10px] mt-2 text-center uppercase tracking-widest font-bold ${isPast ? "text-white" : "text-gray-600"}`}
                                            >
                                              {s.label}
                                            </span>
                                          </div>
                            ...
                            <div className="flex flex-col gap-4 w-full lg:w-72 lg:shrink-0">
                              <div className="bg-black/40 p-6 rounded-3xl border border-white/5 flex flex-col items-center justify-center shadow-lg">
                                ...
                                <p className="text-4xl font-black font-heading text-white text-center">
                                  ₹{booking.totalAmount}
                                </p>
                                {booking.coupon && (
                                  <Badge
                                    variant="outline"
                                    className="mt-2 text-[10px] text-green-400 border-green-500/20 bg-green-500/10 tracking-widest uppercase"
                                  >
                                    Coupon Applied
                                  </Badge>
                                )}
                                <Badge
                                  variant="outline"
                                  className={`mt-3 mb-6 text-[10px] tracking-widest uppercase ${
                                ...
                                booking.status === "REVIEW_PENDING" ? (
                                  <Button
                                    variant="outline"
                                    className="w-full gap-2 border-white/10 text-gray-300 bg-white/5 hover:bg-white/10 hover:text-white rounded-xl mb-3 h-12"
                                    onClick={() =>
                                      setActiveChat({
                                ...
                                {(booking.status === "PENDING" ||
                                  ...
                                  <div className="w-full flex gap-2">
                                    <Button
                                      variant="outline"
                                      className="flex-1 text-red-400 border-red-500/20 bg-red-500/5 hover:bg-red-500/10 hover:text-red-300 rounded-xl h-10 text-xs tracking-widest uppercase font-bold"
                                    ...
                                    <Button
                                      variant="outline"
                                      className="flex-1 text-white border-white/10 bg-white/5 hover:bg-white/10 rounded-xl h-10 text-xs tracking-widest uppercase font-bold"
                                      onClick={() =>
                                        setRescheduleModal(booking.id)
                                      }
                                    >
                                      Move
                                    </Button>
                              ...
                              {(booking.beforeImageUrl ||
                                ...
                                <div className="mb-8">
                                  <h4 className="text-xs font-bold uppercase tracking-widest text-gray-500 mb-4 flex items-center gap-2">
                                    <Camera className="w-4 h-4" /> Service
                                    Images
                                  </h4>
                                    ...
                                    {booking.beforeImageUrl && (
                                      <div className="flex-1 group relative">
                                        ...
                                        <Image
                                          ...
                                          width={500}
                                          height={300}
                                          className="w-full h-40 object-cover rounded-xl border border-white/10 group-hover:border-white/30 transition-colors"
                                        />
                                      </div>
                                    )}
                                    {booking.afterImageUrl && (
                                      <div className="flex-1 group relative">
                                        ...
                                        <Image
                                          ...
                                          width={500}
                                          height={300}
                                          className="w-full h-40 object-cover rounded-xl border-2 border-green-500/30 group-hover:border-green-500/60 transition-colors"
                                        />
                                      </div>
                                    )}
                                  </div>
                                    ...
                                    <div className="bg-black/40 p-5 rounded-2xl border border-white/5">
                                      <div className="flex items-center gap-1 mb-3">
                                        {[...Array(5)].map((_, i) => (
                                          <Star
                                            key={i}
                                            className={`w-4 h-4 ${i < booking.review.rating ? "text-yellow-400 fill-yellow-400 drop-shadow-[0_0_8px_rgba(250,204,21,0.5)]" : "text-white/10"}`}
                                          />
                                        ))}
                                      </div>
            ...
            <TabsContent value="garage" className="space-y-6">
              <Card className="bg-[#141414] border-white/10 shadow-2xl rounded-3xl relative overflow-hidden">
                ...
                <CardHeader className="relative z-10">
                  ...
                  <CardDescription className="text-gray-400 font-light">
                    Save your vehicles for faster booking checkout.
                  </CardDescription>
                </CardHeader>
                  ...
                  >
                    <div>
                      ...
                      <Input
                        ...
                        required
                        className="bg-black/50 border-white/10 rounded-xl h-12 text-white placeholder:text-gray-600 focus-visible:ring-white/20"
                      />
                    </div>
                    <div>
                      <label className="text-xs font-bold uppercase tracking-widest text-gray-500 mb-2 block">
                      ...
                      <Input
                        ...
                        placeholder="e.g. Hunter 350, My Daily"
                        className="bg-black/50 border-white/10 rounded-xl h-12 text-white placeholder:text-gray-600 focus-visible:ring-white/20"
                      />
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        className="bg-black/50 border-white/10 rounded-xl h-12 text-white placeholder:text-gray-600 focus-visible:ring-white/20 uppercase"
                      />
                    </div>
                    <div className="md:col-span-2 pt-4">
                      <Button
                        ...
                        className="bg-white text-black hover:bg-gray-200 font-bold tracking-widest uppercase text-xs h-12 px-8 rounded-xl transition-all shadow-[0_0_20px_rgba(255,255,255,0.1)]"
                      >
                        {addingVehicle ? (
                          <Loader2 className="w-4 h-4 animate-spin mr-2" />
                        ) : (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                {vehicles.map((v) => (
                  <Card
                    key={v.id}
                    className="relative overflow-hidden group bg-[#141414] border-white/5 shadow-xl rounded-2xl"
                  >
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              {bookings.find((b) => b.id === cancelModal)?.payment?.status ===
                "COMPLETED" && (
                <span className="block mt-2 text-green-600 font-medium bg-green-50 p-2 rounded-md border border-green-200">
                  Your payment has been processed. A full refund will be issued
      ...
      <Dialog
        ...
        onOpenChange={() => setRescheduleModal(null)}
      >
        <DialogContent>
          <DialogHeader>
          ...
          <DialogFooter>
            ...
            <Button
              onClick={() =>
                rescheduleModal && handleReschedule(rescheduleModal)
              }
              disabled={isProcessing}
            >
              {isProcessing ? (
