    ...
    <div className="min-h-screen bg-[#0A0A0A] text-white pt-32 pb-24 overflow-hidden">
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        <div className="text-center mb-24 relative">
          ...
          >
            CleanRide was founded on a simple principle: your time is valuable,
            and your vehicle deserves showroom-quality detailing without the
          ...
          >
            ...
            <div className="absolute bottom-10 left-10 right-10">
              ...
              <p className="text-gray-300 text-lg">
                Our partners use industry-leading tools and eco-friendly
                products.
              </p>
            </div>
          </motion.div>
          ...
          >
            <div>
              ...
              <p className="text-gray-400 leading-relaxed">
                Every CleanRide partner undergoes rigorous background checks and
                comprehensive training to ensure your vehicle is in the safest
                hands.
              </p>
            </div>
            <div>
              ...
              <p className="text-gray-400 leading-relaxed">
                From instant booking to live tracking and secure payments, our
                platform is designed to make vehicle care entirely frictionless.
              </p>
            </div>
            <div>
              <div className="w-12 h-12 rounded-xl bg-white/10 flex items-center justify-center mb-6">
              ...
              <p className="text-gray-400 leading-relaxed">
                We utilize water-saving techniques and biodegradable solutions
        ...
        >
          {[
            ...
            <div
              key={i}
              className="bg-[#141414] border border-white/5 rounded-[2rem] p-8 text-center hover:border-white/20 transition-colors"
            >
              <h4 className="text-4xl md:text-5xl font-black mb-2 tracking-tighter">
                {stat.value}
              </h4>
